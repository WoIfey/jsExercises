    ...
    <>
      <main className="min-h-screen">
        <div className="flex justify-center items-center min-h-screen">
          <h1 className="text-[5rem] max-sm:text-2xl text-amber-200 font-extrabold animate__animated animate__slideInLeft animate__infinite">
            Funny Website
          </h1>
          <div className="writing-mode-vertical-lr text-right absolute left-[40%]">
            <p className="transform text-[8rem] max-sm:text-5xl hover:skew-x-12 text-slate-200 -rotate-90 inline-block">
              Wicked
            </p>
          </div>
          <div className="absolute left-[30%]">
            <p className="transform text-[6rem] max-sm:text-2xl text-lime-200 hover:translate-x-6 -rotate-180 inline-block">
              Twisted
            </p>
          </div>
          <p className="hover:opacity-40 text-[5rem] max-sm:text-2xl transform scale-x-(-1) text-green-200">
            Interesting....
          </p>
          <button className="overflow-hidden h-auto w-auto text-4xl max-sm:text-xl font-semibold rounded-lg shadow-lg p-6 bg-amber-100 -bottom-20 text-center text-slate-900 relative z-10 animate__animated animate__slideInDown animate__infinite animate__slow">
            Tell me a joke
          </button>
          <h1 className="absolute z-30 top-[250vh] text-[5rem] max-sm:text-xl m-3 font-extrabold text-slate-100">
            <span>How many bones are in the human body</span>
            <span>|</span>
          </h1>
        </div>
